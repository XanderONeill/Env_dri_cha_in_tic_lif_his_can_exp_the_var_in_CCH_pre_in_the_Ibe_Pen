function dydt = Spanish_ticks_INF(t, y, k)
dydt = zeros(33,1);
...
% Eggs
dydt(11) =  k*r_T*terms(14)*(y(9) + (1-rho)*y(21))           - terms(1)*y(11);
dydt(12) =  k*r_T*terms(15)*(y(10) + (1-rho)*y(22))          - terms(2)*y(12);
...
% Eggs
dydt(23) = k*r_T*terms(14)*y(21)*rho          - terms(1)*y(23);
dydt(24) = k*r_T*terms(15)*y(22)*rho          - terms(2)*y(24);
